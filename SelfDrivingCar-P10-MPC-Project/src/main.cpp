...
int main() {
    ...
    out_log << "x,y,steer,throttle,speed" << endl;
     ...
     */
    h.onMessage([&mpc, &n_loop, &out_log](uWS::WebSocket<uWS::SERVER> ws, char *data,
        ...
        if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    out_log << px << "," << py << "," << steer_value << "," << throttle_value << "," << v << endl;
